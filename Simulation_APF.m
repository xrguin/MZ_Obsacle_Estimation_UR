...
%%
  ...
  %  prevAngle2 = robot2.HeadAngle;
  %  prevAngle3 = robot3.HeadAngle;
%%
...
%%
    ...
    for t = 0:sampleTime:simulationTime
        ...
        if t == 0.5
            prevAngle2_1 = robot2.HeadAngle;
            prevAngle3_1 = robot3.HeadAngle;
        end

        if t >= 0.5
            prevAngle2 = prevAngle2_1;
            prevAngle3 = prevAngle3_1;
        else
            prevAngle2 = robot2.HeadAngle;
            prevAngle3 = robot3.HeadAngle;
        end
%%
        ...
        dTheta2 = abs(robot2.HeadAngle - prevAngle2);
        dTheta3 = abs(robot3.HeadAngle - prevAngle3);
       
        if ~recording && (dTheta2 > turn_threshold || dTheta3 > turn_threshold) && t > 0.5
           recording = true;
        end

        if recording
           poses2_apf = [poses2_apf, robot2.CurrentPose];
           poses3_apf = [poses3_apf, robot3.CurrentPose];
        end
...
%     end
    ...
    n = n + 1;
    apf_pq_r4{n,1} = poses2_apf;
    apf_pq_r4{n,2} = poses3_apf;
...
record_data = true;    
if record_data
    save("C:/Users/10077/Desktop/nd research/code/MZ_Obsacle_Estimation_UR/strict_apf_ally_turn.mat","apf_pq_r4")
...
robot2.CurrentPose = poses2_1(1:4,end);
robot3.CurrentPose = poses3_1(1:4,end);
robot2.Start = poses2_1(1:2,1);
robot3.Start = poses3_1(1:2,1);
robot2.Goal = poses2_1(1:2,end);
robot3.Goal = poses3_1(1:2, end);
figure;
plot(poses2_1(1,:),poses2_1(2,:),'-',...
